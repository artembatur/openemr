  ...
  'IMM_REG' => array(
	...
	'IMM_sendingfacility' => array(
      ...
      //make dure that __DIR is in front of the cert
		...
		'text',                           // data type
                'sites/default/DE-005520_30SANTIAGOP.pem',
	...
	'IMM_receivingfacility' => array(
      ...
      'IMM_TEST_FILE' => array(
		xl('Test File'),
		'text',                           // data type
		'/sites/default/testfile.hl7',
		xl('If this field is filled out, it will send a test file.  During production this should be empty.')  // next step" add choices, display to user
	),
