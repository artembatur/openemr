...
class Message_HL7v2 {
	...
	public $account; // PID.18.1
	public $bill_type; // PID.18.4
	public $abn_flag; // PID.18.5
	public $status; // PID.18.6
	public $fasting; // PID.18.7
	public $ss; // PID.19
	public $ethnicity; // PID.22
	public $facility; // MSH.6
	public $verified_id; // ORC.11
	public $provider_id; // ORC.12
	public $request_notes; // NTE
	public $copy_pat; // ZCC 1.1
	public $copy_acct; // ZCC 1.2
	public $copy_acctname; // ZCC 1.3
	public $copy_fax; // ZCC 1.2
	public $copy_faxname; // ZCC 1.3
...
class Order_HL7v2 {
	...
	public $request_control; // ORC.01 - CDC defined O119
	public $request_number; // ORC.02
	public $request_provider;
	public $lab_number; // result ORC.03
	public $lab_status;	// result ORC.05
	public $test_code;
	public $test_text;
	public $service_id; // OBR.04
	public $zseg; // to determine ZSEG records
...
class Aoe_HL7v2 {
	...
	public $value_type; // OBX.02
	public $observation_code; // OBX.03
	public $observation_label;
	public $observation_text; // OBX.05
	public $section; // for req
	public $display_label; // for req
	public $display_text; // for req
}
...
class Lab_HL7v2 {
	...
	public $code; // ZPS.02
	public $name; // ZPS.03
	public $address; // ZPS.04
	public $phone; // ZPS.05
	public $director; // ZPS.07
	public $clia; // ZPS.09
}
