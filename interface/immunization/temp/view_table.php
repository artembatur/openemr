...
<a class="more" href="/interface/immunization/codes.php?action=add">Add new</a>
<br><br>
<table cellspacing="0" class="immunization_codes">
    ...
    foreach($rows as $row) {
        ...
        <tr>
            ...
            <td><a href="/interface/immunization/codes.php?action=edit&id=<?=$row['id']?>"">Edit</a>
                <a href="/interface/immunization/codes.php?action=del&id=<?=$row['id']?>" onclick="return confirm('Are you sure you want to delete this code?') ? true : false">Del</a>
            </td>
        </tr>
        <?php
    }
