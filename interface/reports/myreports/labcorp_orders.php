...
$ORDERHASH = array(
	...
	'pubpid'  => 'CAST(lab.pid AS SIGNED INTEGER) ASC, lab.order_datetime',
...
if ($_POST['form_refresh'] || $_POST['form_orderby']) {
	...
	if ($quest && (!$form_lab || $form_lab == 'q')) {
		$sub = "SELECT id, pid, pubpid, status, pat_last, pat_first, pat_middle, order0_number AS order_number, order0_datetime AS order_datetime, request_processed, request_provider FROM form_quest_order ";
		$sub .= "WHERE activity = 1 ";
		if ($form_from_date) $sub .= "AND order0_datetime >= '$form_from_date 00:00:00' AND order0_datetime <= '$form_to_date 23:59:59' ";
...
<html>
	...
	<body class="body_top">
		...
		<form method='post' name='theform' id='theform' action='labcorp_orders.php'>
